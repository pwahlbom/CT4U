namespace CT4U.Controllers {
    export class AccountController {
        ...
        constructor(private accountService: CT4U.Services.AccountService, private $location: ng.ILocationService) {
    ...
    export class ConfirmEmailController {
        ...
        constructor(
            private accountService: CT4U.Services.AccountService,
