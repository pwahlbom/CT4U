...
namespace CT4U.Migrations
{
    ...
    [Migration("20160828042832_start")]
    partial class start
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CT4U.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CT4U.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CT4U.Models.Item", b =>
                {
                    ...
                    b.HasOne("CT4U.Models.Receipt", "Receipt")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CT4U.Models.ApplicationUser")
                        .WithMany("Claims")
